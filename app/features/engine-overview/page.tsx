...
export const metadata: Metadata = {
  title: "Institutional Intelligence Overview | PDFBridge",
  description:
    "Discover how PDFBridge deploys high-fidelity synthesis to bridge the gap between unstructured PDFs and strict JSON data. Learn about infrastructure-grade synthesis, smart templates, and automated OCR.",
  keywords: [
    "institutional document parsing",
    "pdf to json extraction",
    "high-fidelity pdf tools",
    "pdfbridge intelligence overview",
    "infrastructure-grade document extraction",
    "institutional invoice parsing"
  ],
  alternates: {
    canonical: "https://pdfbridge.xyz/features/engine-overview",
  },
};
...
const productSchema = {
  ...
  "@type": "Product",
  "name": "PDFBridge Institutional Intelligence",
  "description": "An advanced suite of API tools using high-fidelity infrastructure to extract structured JSON from unstructured PDFs and automatically generate document templates.",
  "brand": {
    "@type": "Brand",
    "name": "PDFBridge"
  },
  ...
  "review": [
    {
      ...
      "reviewBody": "The high-fidelity synthesis is a game changer for our fintech pipeline. It handles messy invoices with near-perfect accuracy."
    }
  ],
  "additionalProperty": [
    {
    ...
    <div className="min-h-screen bg-slate-950 text-white pb-24">
      ...
      <header className="pt-32 pb-16 px-6 max-w-5xl mx-auto text-center relative z-10">
        ...
        <p className="text-xl text-slate-400 leading-relaxed max-w-3xl mx-auto mb-10">
          PDFBridge pairs best-in-class HTML-to-PDF rendering with state-of-the-art infrastructure. Parse messy invoices into strict JSON, or prompt our engine to write pixel-perfect Tailwind receipt templates instantly.
        </p>
      </header>
        ...
        <section className="mb-24 grid lg:grid-cols-2 gap-16 items-center">
          <div>
             ...
             <p className="text-slate-400 text-lg leading-relaxed mb-6">
                Legacy OCR breaks whenever a vendor changes their invoice layout. By passing documents through our Intelligence Synthesis endpoint, you define the desired output structure, and we intelligently map visual bounds to your schema.
             </p>
             ...
             <Link href="/features/intelligence-synthesis" className="text-purple-400 font-bold hover:text-purple-300 flex items-center gap-2 w-max">
               Explore Intelligence Synthesis <ArrowRight size={16} />
             </Link>
          </div>
      ...
      "amount": 400.50
        ...
        <section className="mb-24 grid lg:grid-cols-2 gap-16 items-center flex-col-reverse lg:flex-row-reverse">
          <div>
             ...
             <h2 className="text-3xl font-black mb-4">Infrastructure-Grade Templates</h2>
             <p className="text-slate-400 text-lg leading-relaxed mb-6">
                Don't waste hours writing inline CSS for email chains and document templates. PDFBridge's Intelligence Lab allows you to scaffold complex, stylized Tailwind PDF templates using simple natural language prompts.
             </p>
             <ul className="space-y-3 mb-8 text-slate-300">
  ...
  <!-- ... generated code ... -->
      ...
      <section className="max-w-4xl mx-auto px-6 mt-12 mb-12">
        <div className="p-10 rounded-3xl bg-linear-to-r from-purple-900/40 to-pink-900/40 border border-purple-500/20 text-center">
          ...
          <p className="text-slate-300 mb-8">Sign up today to test the Intelligence Synthesis API and template builder.</p>
