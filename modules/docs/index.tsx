      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <main className="flex-1 space-y-20 min-w-0">
          ...
          >
            ...
            <p className="text-lg">
              Welcome to the PDFBridge API. Our platform provides
              high-performance Chromium-based PDF generation from URLs or HTML
              payloads. Designed for developers who need scale, security, and
              precision.
            </p>
            <GlowCard
              title="Base URL"
              ...
              content={
                <div className="mt-4 p-4 rounded-xl bg-black/40 border border-white/5 font-mono text-sm text-blue-400">
          ...
          <section id="auth" className="scroll-mt-24 space-y-6">
            ...
            <p className="text-slate-400 leading-relaxed">
              ...
              header. You can find or rotate your keys in the dashboard
              settings.
            </p>
            <CodeBlock
