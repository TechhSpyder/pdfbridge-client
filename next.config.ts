    ...
    return [
      {
        ...
        headers: [
...

          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.paddle.com https://sandbox-cdn.paddle.com https://*.paddle.com https://*.clerk.accounts.dev https://*.pdfbridge.xyz https://*.vercel-scripts.com https://challenges.cloudflare.com https://*.hcaptcha.com https://hcaptcha.com https://public.profitwell.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://sandbox-cdn.paddle.com https://cdn.paddle.com https://*.hcaptcha.com https://hcaptcha.com",
              "img-src 'self' data: https://challenges.cloudflare.com https://*.paddle.com https://cdn.paddle.com https://*.clerk.com https://images.unsplash.com https://res.cloudinary.com https://*.hcaptcha.com https://hcaptcha.com https://global.localizecdn.com",
              "font-src 'self' https://fonts.gstatic.com",
              "connect-src 'self' http://localhost:3001 http://localhost:3003 https://challenges.cloudflare.com https://*.paddle.com https://api.paddle.com https://sandbox-checkout-service.paddle.com https://checkout-service.paddle.com https://*.clerk.accounts.dev https://*.pdfbridge.xyz https://pdfbridge-api-1.onrender.com https://vitals.vercel-insights.com https://*.hcaptcha.com https://hcaptcha.com https://*.profitwell.com https://paddlecfe.report-uri.com https://*.ingest.sentry.io https://global.localizecdn.com",
